return {
  ...
  config = function()
    require('maximizer').setup {
      ...
      vim.keymap.set('n', '<leader>z', '<cmd>lua require("maximizer").toggle()<CR>', { desc = 'Maximi[Z]er (Use tz)', silent = true, noremap = true }),
      vim.keymap.set('n', '<leader>tz', '<cmd>lua require("maximizer").toggle()<CR>', { desc = '[T]oggle Maximi[Z]er', silent = true, noremap = true }),
