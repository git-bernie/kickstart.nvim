...
require('lazy').setup {
  ...
  { 'NMAC427/guess-indent.nvim', event = 'BufReadPost', opts = {} }, -- Detect tabstop and shiftwidth automatically
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Uses grr to align with Neovim 0.11 built-in gr* prefix convention
          -- (grn = rename, gra = code action are now Neovim 0.11 built-ins)
